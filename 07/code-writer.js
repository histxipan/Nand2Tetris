...
function createJudgementString(judge, index) {
    // First subtract the two numbers and then process according to the given condition: greater than equal to less than
    ...
    let str = '@SP\r\n'
            ...
            + 'A=A-1\r\n'
            + 'D=M-D\r\n'
            + '@TRUE' + index + '\r\n' // If the conditions are met, then jump to the address marked by symbol1
